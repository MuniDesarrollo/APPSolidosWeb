...
$json['img']=array();
	...
	if(isset($_POST["btn"])){
		...
		$sql="INSERT INTO usuario(nombre,profesion,imagen,ruta_imagen) VALUES (?,?,?,?)";
		$stm=$conexion->prepare($sql);
		$stm->bind_param('ssss',$nombre,$profesion,$bytesArchivo,$ruta);
		
		if($stm->execute()){
			echo 'imagen Insertada Exitosamente ';
			/*$consulta="select * from usuario where documento='1'";
